  ...
  <div class="col-lg-12">
      ...
      <div class="modal fade" id="addServiceModal" tabindex="-1" aria-labelledby="addServiceModalLabel" aria-hidden="true">
        ...
        <form action="" method="post" enctype="multipart/form-data" id="addMenuForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="" placeholder="Enter Your Title" name="f_name" minlength="3" >
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="" placeholder="Enter Your Title" name="price" >
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                <label for="icon-description" class="form-label"> Description</label>
                <textarea type="text" class="form-control" id="" placeholder="Enter Your Description" name="description" ></textarea>
            </div>
    ...
    <div class="modal-body">
        <form action="" method="post" enctype="multipart/form-data" id="updateForm">  
            ...
            <div class="mb-3">
                <label for="icon-name" class="form-label">Name</label>
                <input type="text" class="form-control" id="edit_name" placeholder="Enter Your Title" name="f_name" >
                <div class="error-message" style="color:red; display:none;"></div>
            </div>
            <div class="mb-3">
                <label for="icon-name" class="form-label">Price</label>
                <input type="text" class="form-control" id="price" placeholder="Enter Your Title" name="price" >
            </div>
            <div class="mb-3">
                <label for="icon-image" class="form-label">Image</label>
                ...
                <div class="mb-3">
                <label for="icon-description" class="form-label"> Description</label>
                <input type="text" class="form-control" id="edit_description" placeholder="Enter Your Description" name="description" >
      ...
      <table class="table datatable">
        ...
        <tr>
            ...
            <td>
              ...
              <a class="btn btn-danger  btn-sm" href="delete/{{ $items->u_id }}" onclick="return confirm('Are you sure?');">Delete</a>
            </td>
        </tr>
       @endforeach
       </tbody>
